...
{else}
<!--fix error comment in photo in version < 3.7.2 -->
<?php if (! isset ( $this->_aVars['aFeed']['can_post_comment'] )): ?>
    <?php $this->_aVars['aFeed']['can_post_comment'] = true; ?>
<?php endif; ?>
<?php if (! isset ( $this->_aVars['aFeed']['type_id'] )): ?>
    <?php $this->_aVars['aFeed']['type_id'] = $this->_aVars['aFeed']['comment_type_id']; ?>
<?php endif; ?>
<?php if (! isset ( $this->_aVars['aFeed']['is_view_item'] )): ?>
    <?php $this->_aVars['aFeed']['is_view_item'] = true; ?>
<?php endif; ?>
<!--end-->
...
<div class="js_parent_feed_entry parent_item_feed">
    ...
    <div class="js_feed_comment_border">
        ...
        <div class="like_count">
            ...
            {if Phpfox::getParam('like.allow_dislike') &&Phpfox::isUser() && Phpfox::isModule('like') && isset($aFeed.like_type_id)}

            {template file='bettermobile.block.displayactions'}
