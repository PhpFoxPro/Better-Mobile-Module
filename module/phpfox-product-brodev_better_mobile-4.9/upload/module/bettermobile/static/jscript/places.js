...
$Core.Feed =
{
    ...
    displaySuggestions: function()
    {
        ...
        $('#js_add_location_suggestions').html(sOut).css({'z-index': 900, 'max-height':'200px'}).show();
    },
    ...
    chooseLocation: function(id)
    {
        ...
        $('.location_title').hide();
        $('#js_loction_show').show();
        $('#js_loction_show .value').html('At ' + oPlace['name']);
    ...
    cancelCheckIn: function()
    {
        ...
        $('#js_add_location, #js_location_input, #js_loction_show').hide();
        $('.activity_feed_form_button_position').show();
