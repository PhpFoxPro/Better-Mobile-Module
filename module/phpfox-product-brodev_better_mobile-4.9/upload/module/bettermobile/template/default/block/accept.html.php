				...
				<div class="drop_data_user">
					...
					<div class="profile_friend_link">
						...
						<div class="extra_info_link" style="position: absolute;right: 17px;top: 0;padding: 0;">
							<a href="#" style="font-size: 10px;" onclick="$Core.box('friend.getMutualFriends', 300, 'user_id={$aFriend.friend_user_id}'); return false;">
					...
					<ul class="extra_info_middot" style="display:none;position: absolute;top: 25px;">
