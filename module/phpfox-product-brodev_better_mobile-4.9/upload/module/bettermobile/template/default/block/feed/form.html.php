...
{php}
    $aUsers = Phpfox::getUserBy();
    $this->_aVars['aUsers'] = $aUsers;
{/php}
...
<div class="activity_feed_form_share">
    ...
    <ul class="activity_feed_form_attach">
        ...
        {/if}
        <li>
            <a class="share_photo_button" href="#" onclick="oFeedOthers.show1(); return false;"
        ...
        <div class="other_share">
            <ul>
                ...
                <li class="{$aFeedStatusLink.module_id}">
...
<div class="activity_feed_form" style="display: none;">
    <form method="post" action="#" id="js_activity_feed_form" enctype="multipart/form-data">
            ...
            <div class="activity_feed_form_button_status_info">
                <div class="share-info">
                    <div class="img-status">
                        {img user=$aUsers suffix='_50_square' max_width=50 max_height=50}
                    </div>
        ...
        <div class="activity_feed_form_button_position_button">
            <input type="submit" value="{phrase var='feed.share'}" id="activity_feed_submit" onclick="oStatus.check();"
                   class="button_status"/>
        </div>
